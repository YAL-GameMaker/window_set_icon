...
set extName=window_set_icon
set dllName=window_set_icon
set gmlDir14=%solutionDir%window_set_icon.gmx
set gmlDir22=%solutionDir%window_set_icon_yy
set gmlDir23=%solutionDir%window_set_icon_23
